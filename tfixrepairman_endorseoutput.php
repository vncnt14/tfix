        ...
        function showDIAGNOSIS() {
            ...
            <input type="hidden" id="reqform_id" name="reqform_id" value="<?php echo $findingsData['reqform_id'];?>">
                <div class="content-columns">
                    ...
                    <!-- Updated column box for quantity -->
                    <div class="column-box">
                        <div>Quantity:</div>
                    </div>
                    ...
                    <!-- Cancel and Next buttons -->
                        <div class="button-container">
                            ...
                            <a href="tfixrepairman_endorse3.php?user_id=<?php echo $findingsData['user_id'];?>&reqform_id=<?php echo $findingsData['reqform_id'];?>"><button type="button" class="next-button">PROCEED</button></a>
                        </div>
                </div>
            </form>`;
        }
