...
.btn-request-service {
        ...
        <header>
            ...
            <a href="tfixlanding.html" class="logo">Tfix</a>
	...
	<div class="container">
		<form action="register2.php" method="POST" class="login active">
            <h2 class="title">Register your account</h2>

            <div class="form-group">
              <label for="usertype"></label>
              <div class="input-group">
                <input type="hidden" id="usertype" name="usertype" value="Repairman" placeholder="">
              </div>
            </div>
			...
			<div class="form-group">
				<label for="appliance">Appliance Expertise</label>
				<div class="input-group">
					<select id="appliance" name="appliance" class="form-select">
			...
			<p>I already have an account. <a href="tfixrepairman_login.php">Login</a></p>
		</form>
