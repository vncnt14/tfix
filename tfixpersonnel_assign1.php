...
$query1 = "SELECT *FROM electricfan WHERE user_id = '$user_id' AND reqform_id = '$reqform_id'";
...
<body>
    ...
    <script>
       ...
       let problemDescription = "";
        ...
        function showDIAGNOSIS() {
            ...
            <form action="tfixpersonnel_assignfan.php" method="POST">
            ...
            <div class="content-columns">
                    ...
                    value="<?php echo $findingsData['motor'] . ' ' . 
                            $findingsData['loose'] . ' ' . 
                            $findingsData['jamming'] . ' ' . 
                            $findingsData['faulty'] . ' ' . 
                            $findingsData['lubrication'] . ' ' . 
                            $findingsData['worn'] . ' ' . 
                            $findingsData['electrical'] . ' ' . 
                            $findingsData['capacitor'] . ' ' . 
                            $findingsData['stuck'] . ' ' . 
                            $findingsData['overheating'] . ' ' . 
                            $findingsData['defective'] . ' ' . 
                            $findingsData['damaged']; ?>">  
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="unit_name" name="unit_name" class="repair-input" value="Electric Fan" readonly>
                    </div>
                    ...
                    <div class="column-box-input">
                        <select id="part_description" name="parts_description" class="repair-input">
                    ...
                    <div class="column-box-input">
                        <input type="date" id="repairstatus" name="finish_date" class="repair-input" >
                    </div>
                    ...
                    <div class="column-box-input">
                        <select id="part_description" name="duration" class="repair-input">
                            <option value="None">Choose</option>
    ...
    if (unitName === "Refrigerator") { // Check if unitName is "Refrigerator"
