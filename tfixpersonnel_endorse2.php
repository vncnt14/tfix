...
$query = "SELECT *FROM repairman WHERE online_status = 'online'";
        ...
        <div class="timeline-section">
            ...
            <table class="table">
                <thead class="v-2 text-light">
                 ...
                 <input type="hidden" name="unit_brand" id="unit_brand" value="<?php echo $reqformData['unit_brand'];?>">   
                </thead>
                    ...
                    <?php
                        if ($result) {
                            foreach ($result as $row) {
                                ...
                                echo '<td>';
                                echo '<a href="tfixpersonnel_endorse3.php?repairman_id=' . (int)$row['repairman_id'] . '&user_id=' . (int)$userData['user_id'] . '&reqform_id=' . (int)$reqformData['reqform_id'] . '&unit_brand=' . urlencode($reqformData['unit_brand']) . '" class="btn btn-primary offset-6">View Assign</a>';
                                echo '</td>';
