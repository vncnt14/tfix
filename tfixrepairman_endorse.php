    ...
    <script>
       ...
       let problemDescription = "";
        ...
        function showDIAGNOSIS() {
            ...
            <form action="tfixrepairman_endorse1.php" method="POST">
...
<div class="column-box-input">
    <select id="unit_name" name="unit_name" class="repair-input" onchange="updateOptions()">
...
<div class="column-box-input">
    <select id="part_description" name="part_description" class="repair-input">
        <option value="None">Choose</option>
...
<div class="column-box-input">
    <select id="assigned_technician" name="assigned_technician" class="repair-input">
        <option value="None">Choose</option>
    ...
    if (unitName === "Refrigerator") {
        ...
        let electricFanTechnicians = [
            { value: "Alice Johnson", text: "Alice Johnson" },
