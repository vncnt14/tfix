    ...
    <section>
        ...
        <div class="timeline-section">
            <div class="timeline-buttons">
                ...
                <button class="timeline-button vc1" onclick="showPendingRequest()">SERVICE</button>
    ...
    <script>
       ...
       let problemDescription = "";
        ...
        function showDIAGNOSIS() {
            ...
            <form action="tfixrepairman_service3.php" method="POST">
            <input type="hidden" id="assign_id" name="assign_id" value="<?php echo $findingsData['assign_id'];?>">
            ...
            <input type="hidden" id="reqform_id" name="reqform_id" value="<?php echo $findingsData['reqform_id'];?>">
                <div class="content-columns">
                    ...
                    value="<?php echo $reqformData['date_requested'];?>" readonly>  
                    </div>
                    ...
                    <div class="column-box-input">
                        <select id="unit_status" name="unit_status" class="repair-input">
                    ...
                    <div class="column-box-input">
                    <input type="text" id="unit_brand" name="assign_tech" class="repair-input" value="<?php echo $findingsData['assign_tech'];?>" readonly>
                    </div>
                    ...
                    <div class="column-box-input">
                        <select id="changed_technician" name="change_tech" class="repair-input">
                            <option value="none">None</option>
                            <?php
                            // Assuming $technicians is an array of technician names
                            $technicians = array("Kakashi Hatake", "Might Guy", "Tobirama Uzumaki");
                    ...
                    <div class="column-box-input">
                    <input type="text" id="inspect" name="start_date" class="repair-input" value="<?php echo $findingsData['start_date'];?>" readonly >
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="date" id="repairstatus" name="finish_date" class="repair-input" value="">
                    </div>
                    ...
                    <div class="column-box-input">
                        <select id="duration" name="duration" class="repair-input">
...
<div id="delayReason" style="display: none;">
    <div class="column-box">
        <div>Reason for Delay:</div>
    </div>
    <div class="column-box-input">
        <input type="text" id="delay_reason" name="delay_reason" class="repair-input">
    </div>
</div>
    ...
    const statusSelect = document.getElementById("unit_status");
    const delayReason = document.getElementById("delayReason");
    const selectedStatus = statusSelect.value;

    // If the selected status is "On Hold", show the reason input field; otherwise, hide it
    if (selectedStatus === "On Hold") {
        delayReason.style.display = "block";
    } else {
        delayReason.style.display = "none";
    }
}
