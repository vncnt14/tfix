...
$query3 = "SELECT *FROM parts WHERE unit_brand = '$unit_brand' AND parts_name = '$parts_name'";
    ...
    <script>
       ...
       let problemDescription = "";
        ...
        function showDIAGNOSIS() {
            ...
            <form action="tfixrepairman_service5.php" method="POST">
            ...
            <input type="hidden" id="unit_brand" name="unit_brand" value="<?php echo $partsData['unit_brand'];?>">
            <input type="hidden" id="unit_brand" name="parts_name" value="<?php echo $partsData['parts_name'];?>">
                <div class="content-columns">
                    ...
                    <div class="column-box-input">
                        <input type="text" id="description" name="description" class="repair-input" value="None" readonly>
                    </div>
                    ...
                    <div class="column-box-input">
                        <input type="text" id="description" name="description" class="repair-input" value="<?php echo $findingsData['finish_date'];?>" readonly>
                    </div>
                    ...
                    <div class="column-box-input">
                        <input type="text" id="description" name="description" class="repair-input"value="<?php echo $findingsData['duration'];?>" readonly>
                    </div>
