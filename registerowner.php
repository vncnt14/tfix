    ...
    <section>
      ...
      <div class="request-service-section">
        <div class="right-section">
          ...
          <form class="details-form" action="registowner1.php" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="photo" id="photo" placeholder="Edit your Photo">
          ...
          <!-- First Form Section: Shop Name -->
          <div class="form-section">
                <label for="shop_name">Shop Name:</label>
                <input type="text" id="shop_name" name="shop_name" required>
            </div>

            <!-- Second Form Section: Shop Location -->
            <div class="form-section">
                <label for="shop_location">Shop Location:</label>
                <input type="text" id="shop_location" name="shop_location" required>
            </div>

            <!-- Third Form Section: Type of Shop (Dropdown Menu) -->
            <div class="form-section">
                <label for="shop_type">Type of Shop:</label>
                <select id="type_of_shop" name="shop_type" required>
            ...
            <!-- Fourth Form Section: Shop Permit (Upload Photo) -->
            <div class="form-section shop-permit-section">
              <label for="shop_permit" class="file-upload">Shop Permit</label>
              <div class="section-box">
                <input type="file" id="shop_permit" name="shop_permit" accept="image/*" required style="position: relative; top: -15px;">
              </div>
            </div>
                ...
                <div class="payment-method">
                    ...
                    <label><input type="checkbox" name="shop_payment[]" value="Cash"> Cash</label>
                    <label><input type="checkbox" name="shop_payment[]" value="GCash"> G-cash</label>
                    <label><input type="checkbox" name="shop_payment[]" value="PayPal"> PayPal</label>
                </div>
                ...
                <button class="cancel-btn" type="submit">Apply</button>
              </div>
            </form>
        </div>
      </div>
