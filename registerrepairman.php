...
<head>
  ...
  <style>
    ...
    .skill-expertise input[type="checkbox"] .type-appliance input[type="checkbox"] {
      margin-right: 5px;
  ...
  <section>
    ...
    <div class="request-service-section">
      <div class="right-section">
        ...
        <form class="details-form" action="tfixrepairman_register.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-section">
            ...
            <select id="years_of_experience" name="experience" required>
          ...
          <div class="skill-expertise">
            ...
            <label><input type="checkbox" name="expertise[]" value="Repair"> Repair</label>
            <label><input type="checkbox" name="expertise[]" value="Troubleshooting"> Troubleshooting</label>
            <label><input type="checkbox" name="expertise[]" value="Installation"> Installation</label>
          </div>

          <!-- skills-->
          <div class="type-appliance">
            <label>Types of Appliance:</label>
            <label><input type="checkbox" name="appliance[]" value="Refrigerator"> Refrigerator</label>
            <label><input type="checkbox" name="appliance[]" value="Washing Machine"> Washing Machine</label>
            <label><input type="checkbox" name="appliance[]" value="Electric Fan"> Electric Fan</label>
          </div>
