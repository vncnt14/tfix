            ...
            <div class="right-section">
                ...
                <form class="details-form">
                    <div class="form-section">
                        ...
                        <input type="text" id="firstname" name="firstname" value="<?php echo $repairmanData['firstname']; ?>" disabled>

                        <label for="expertise">Expertise:</label>
                        <input type="text" id="expertise" name="expertise" value="<?php echo $repairmanData['expertise']; ?>" disabled>
                        
                    </div>

                    <div class="form-section">
                        <label for="lastname">Last Name:</label>
                        <input type="text" id="lastname" name="lastname" value="<?php echo $repairmanData['lastname']; ?>"disabled>
                        
                        <label for="experience">Years of expertise:</label>
                        <input type="text" id="experiences" name="experience" value="<?php echo $repairmanData['experience']; ?>" disabled>
                    </div>

                    
                    <div class="form-section">
                        <label for="email">Email Address:</label>
                        <input type="email" id="email" name="email" value="<?php echo $repairmanData['email']; ?>" disabled>

                    </div>
                    <div class="form-section">
                        <label for="username">Username:</label>
                        <input type="text" id="username" name="username" value="<?php echo $repairmanData['username']; ?>" disabled>
                    </div>

                    <div class="form-section">
                        <label for="password">Password:</label>
                        <input type="password" id="password" name="password"  value="<?php echo $repairmanData['password']; ?>"disabled>
                    </div>
                    
                    <!-- Save Changes button added here -->
                    <a href="tfixrepairman_editprofile1.php"><button type="button" class="save-changes-btn">Edit Profile</button></a>
