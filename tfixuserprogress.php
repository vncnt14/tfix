        ...
        function showDIAGNOSIS() {
            ...
            <form action="" method="POST">
                ...
                <div class="content-columns">
                    ...
                    <div class="column-box-input">
                    <input type="text" id="inspect" name="unit_name" class="repair-input" value="<?php echo $progressData['unit_type'];?>" readonly >
                    </div>
                    ...
                    <!-- Cancel and Next buttons -->
                        <div class="button-container">
                            ...
                            <?php
                                ...
                                echo '<a href="tfixuserprogress1.php?user_id=' . $user_id . '"><button type="button" class="next-button">VERIFY</button></a>';
                            ?>
                        </div>
                </div>
            </form>`;
