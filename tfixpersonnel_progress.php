...
if (isset($_GET['user_id']) && isset($_GET['reqform_id'])) {
    ...
    $result = mysqli_query($connection, "SELECT user.user_id, user.firstname, user.lastname, reqform_id, date_requested, unit_type
    FROM user
       ...
       let problemDescription = "";
        ...
        function showDIAGNOSIS() {
            ...
            document.querySelector('.timeline-content').innerHTML = `
                <form action="tfixpersonnel_refrigerator.php" method="POST">
                    ...
                    <div class="checkbox-container">
                        <div class="checkbox-group">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" id="faultythermo	" name="faultythermo" class="checkbox-input" value="Faulty Thermostat">
                                Faulty Thermostat
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="defective" name="defective" class="checkbox-input" value="Defective Evaporator Fan Motor">
                                Defective Evaporator Fan Motor
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="clogged" name="clogged" class="checkbox-input" value="Clogged Condenser Coils">
                                Clogged Condenser Coils
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="faultydef" name="faultydef" class="checkbox-input" value="Faulty Defrost Timer or Heater">
                                Faulty Defrost Timer or Heater
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="low" name="low" class="checkbox-input" value="Low Refrigerant Levels">
                                Low Refrigerant Levels
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="malfunctioning" name="malfunctioning" class="checkbox-input" value="Malfunctioning Compressor">
                                Malfunctioning Compressor
                            </label>
                            </div>
                            <div class="checkbox-group">
                                <label class="checkbox-label">
                                    <input type="checkbox" id="gasket" name="gasket" class="checkbox-input" value="Damaged Door Gasket">
                                    Damaged Door Gasket
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" id="vent" name="vent" class="checkbox-input" value="Blocked Air Vents">
                                    Blocked Air Vents
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" id="thermostat" name="thermostat" class="checkbox-input" value="Faulty Temperature Control Thermostat">
                                    Faulty Temperature Control Thermostat
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" id="coils" name="coils" class="checkbox-input" value="Frost Buildup on the Evaporator Coils">
                                    Frost Buildup on the Evaporator Coils
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" id="charge" name="charge" class="checkbox-input" value="Inadequate Refrigerant Charge">
                                    Inadequate Refrigerant Charge
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" id="condenser" name="condenser" class="checkbox-input" value="Faulty Condenser Fan Motor">
