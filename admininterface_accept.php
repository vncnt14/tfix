...
<body>
    ...
    <section>
        <!-- main content -->
        <div class="new-requests-text">ACCEPT DATABASE</div>
        ...
        <table>
            ...
            <?php
                ...
                foreach ($result as $ownersData) {
                    ...
                    echo "<form action='admininterface_accept1.php' method='POST'>";
                    echo "<input type='hidden' name='accept_id' value='" . $ownersData['accept_id'] . "'>";
