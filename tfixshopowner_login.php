...
.btn-request-service {
	...
	<div class="container">
		<form action="tfix_shopowner_login.php" method="POST" class="login active">
			...
			<p>I don't have an account. <a href="tfixshopowner_create.php">Register</a></p>
		</form>
