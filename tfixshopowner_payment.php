...
$query = "SELECT ar.*, rf.user_id, u.firstname, u.lastname, u.address, u.contact
          ...
          JOIN user u ON rf.user_id = u.user_id WHERE u.user_id = '$user_id' AND rf.reqform_id = $reqform_id";
$result = mysqli_query($connection, $query);
...
$query3 = "SELECT * FROM parts WHERE unit_brand IN (SELECT unit_brand FROM reqform WHERE unit_brand = '$unit_brand' AND parts_name = '$parts_name')";;
       ...
       let problemDescription = "";
        ...
        function showDIAGNOSIS() {
            ...
            <form action="tfixshopowner_payment1.php" method="POST">
                ...
                <input type="hidden" id="reqform_id" name="assign_id" value="<?php echo $progressData['assign_id'];?>">
                <input type="hidden" id="reqform_id" name="reqform_id" value="<?php echo $progressData['reqform_id'];?>">
                <input type="hidden" id="reqform_id" name="unit_brand" value="<?php echo $progressData['unit_brand'];?>">
                <input type="hidden" id="reqform_id" name="parts_name" value="<?php echo $progressData['parts_name'];?>">
                <div class="content-columns">
                    ...
                    <div class="column-box-input">
                    <input type="text" id="inspect" name="unit_name" class="repair-input" value="Refrigerator" readonly >
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="inspect" name="parts" class="repair-input"  value="<?php echo $partsData['price'];?>" required>
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="inspect" name="labor" class="repair-input"  value="" required>
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="inspect" name="payment" class="repair-input" value="" readonly>
                    </div>
