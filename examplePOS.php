...
$query = "SELECT ar.*, rf.user_id, u.firstname, u.lastname, u.address, u.contact
          FROM assignref ar
...
$query3 = "SELECT *FROM parts where unit_id";
...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-vk5WoKI8N3k3PCZng4Ff3ZtXl9iAqDxHL/WGLu6zHtkgb8S3BZgNti8+BI+Q8w9x" crossorigin="anonymous">
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <form action="tfixshopowner_payment1.php" method="POST">
    ...
    <input type="hidden" id="reqform_id" name="reqform_id" value="<?php echo $progressData['reqform_id'];?>">
        <div class="content-columns">
            ...
            <div class="column-box-input">
                <select id="part_description" name="parts" class="repair-input">
                    ...
                    <?php
                        ...
                        if (!empty($result3)) {
                            foreach ($result3 as $part) {
                                echo '<option value="' . $part['price'] . '">' .'Php '. $part['price'] . '</option>';
                            }
                        } else {
            ...
            <div class="column-box-input">
            <input type="text" id="inspect" name="labor" class="repair-input"  value="">
            </div>
            ...
            <div class="column-box-input">
            <input type="text" id="inspect" name="payment" class="repair-input" readonly>
            </div>
...
<!-- JavaScript to handle modal functionality -->
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-kvypjFy5j5z+FAFFL93ZvpwG0YVjW7x7jk3Gz9L5sYaezDCKFDqp0FnhJW0M+aCZ" crossorigin="anonymous"></script>
