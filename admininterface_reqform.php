...
$query = "SELECT * FROM reqform INNER JOIN user ON reqform.user_id = user.user_id";
...
<body>
    ...
    <section>
        <!-- main content -->
        <div class="new-requests-text">REQUEST FORMS</div>
        ...
        <table>
            ...
            <?php
                ...
                foreach ($result as $ownersData) {
                    ...
                    echo "<td>" . $ownersData['unit_problem'] . "</td>";
                    echo "<td>" . $ownersData['unit_type'] . "</td>";
                    echo "<td>" . $ownersData['unit_brand'] . "</td>";
                    echo "<td>" . $ownersData['unit_model'] . "</td>";
                    echo "<td>" . $ownersData['date_requested'] . "</td>";
                    echo "<td>" . $ownersData['type_service'] . "</td>";
                    // Assuming you want an 'Edit' link for each owner
                    echo "<td style='text-align:center;'>";
                    echo "<form action='admininterface_reqform1.php' method='POST'>";
                    echo "<input type='hidden' name='reqform_id' value='" . $ownersData['reqform_id'] . "'>";
