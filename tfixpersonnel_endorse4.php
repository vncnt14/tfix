...
$query = "SELECT af.*, u.firstname, u.lastname
          FROM assignfan af
          JOIN user u ON af.user_id = u.user_id
          WHERE af.user_id = '$user_id' AND af.reqform_id = '$reqform_id'";
...
<body>
    ...
    <section class="v-3">
        ...
        <a href="tfixpersonnel_assign1.php?user_id=<?php echo $user_id; ?>&reqform_id=<?php echo $reqform_id; ?>&repairman_id=<?php echo $repairman_id; ?>">
