...
$query1 = "SELECT ar.*, rf.user_id, u.firstname, u.lastname, u.address, u.contact, rc.labor, rc.parts, rc.payment
FROM assignref ar
        ...
        <div class="v-1 alert alert-info" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="notif-word">
                    <h6 class="alert-heading text-light fw-bold">CUSTOMER PAID THE PAYMENT.<i> <img src="Ellipse 12.png" class="icon-v1" alt=""></i></h6>
                    <a href="tfixshopowner_notif1.php"><p class="text-light">Click to here view payment details.</p></a>
