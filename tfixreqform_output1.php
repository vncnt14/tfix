    ...
    <section>
        ...
        <div class="request-service-section">
            <div class="right-section">
                ...
                <form class="details-form" action="tfixpersonnel_accept.php" method="GET">
                    <div class="form-section">
                        <input type="hidden" id="user_id" name="user_id" value="<?php echo $userData['user_id'];?>">
                        <label for="firstname">First Name:</label>
                        <input type="text" id="firstname" name="firstname"  value="<?php echo $userData['firstname'];?>" disabled>
            

                        <label for="contact">Phone Number:</label>
                        <input type="text" id="contact" name="contact" value="<?php echo $userData['contact'];?>" disabled>
                    </div>

                    <div class="form-section">
                        <label for="lastname">Last Name:</label>
                        <input type="text" id="lastname" name="lastname"  value="<?php echo $userData['lastname'];?>" disabled>

                        <label for="address">Complete Home Address:</label>
                        <input type="text" id="address" name="address"  value="<?php echo $userData['address'];?>" disabled>
                    </div>
                   ...
                   <!-- reqform table in database  -->
                    ...
                    <div class="form-section">
                        ...
                        <input type="text" id="unit_name" name="unit_name"  value="<?php echo $reqformData['unit_name'];?>" disabled>
                    </div>
                    <div class="form-section">
                        ...
                        <input type="text" id="unit_problem" name="unit_problem"  value="<?php echo $reqformData['unit_problem'];?>" disabled>
                    </div>

                    <div class="form-section">
                        <label for="othert_problem">Other Problem:</label>
                        <input type="text" id="other_problem" name="other_problem"  value="<?php echo $reqformData['other_problem'];?>" disabled>
                    </div>

                    <div class="form-section">
                        <label for="date_requested">Date Requested:</label>
                        <input type="text" id="date_requested" name="date_requested"  value="<?php echo $reqformData['date_requested'];?>" disabled>
                    </div>

                    <div class="form-section">
                        <label for="type_service">Type of Service:</label>
                        <input type="text" id="type_service" name="type_service"  value="<?php echo $reqformData['type_service'];?>" disabled>
                    </div>
