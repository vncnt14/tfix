...
$query = "SELECT user.user_id, user.firstname, user.lastname, reqform_id, date_requested
          FROM user
...
<body>
                ...
                <div class="content-box">
                    <div class="checkbox-container">
                        <div class="checkbox-group">
                            <label class="checkbox-label">
                                ...
                                <input type="checkbox" id="faultythermo	" name="faultythermo" class="checkbox-input">
                                Faulty Thermostat
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="defective" name="defective" class="checkbox-input">
                                Defective Evaporator Fan Motor
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="clogged" name="clogged" class="checkbox-input">
                                Clogged Condenser Coils
                            </label>
                        </div>
                        <div class="checkbox-group">
                            <label class="checkbox-label">
                                <input type="checkbox" id="faultydef" name="faultydef" class="checkbox-input">
                                Faulty Defrost Timer or Heater
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="low" name="low" class="checkbox-input">
                                Low Refrigerant Levels
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="malfunctioning" name="malfunctioning" class="checkbox-input">
                    ...
                    <div class="checkbox-container">
                        <div class="checkbox-group">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" id="repairstatusYES" name="repairstatusYES" class="checkbox-input">
                                Yes
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="repairstatusNO" name="repairstatusNO" class="checkbox-input">
                                No
                            </label>
                        </div>
                    </div>

                    <!-- Additional text and input box -->
                    <div class="repair-description">Findings:</div>
                    <input type="text" id="findings" name="findings" class="repair-input" placeholder="Problem description here" style=background-color: #6C6B6B;">
    ...
    let unitNameValue = "<?php echo isset($reqformData['unit_name']) ? htmlspecialchars($reqformData['unit_name']) : ''; ?>";
