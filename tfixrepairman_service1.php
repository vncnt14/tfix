...
$query1 = "SELECT *FROM assignref WHERE user_id = '$user_id' AND reqform_id = '$reqform_id'";
        ...
        function showDIAGNOSIS() {
            ...
            <input type="hidden" id="reqform_id" name="reqform_id" value="<?php echo $findingsData['reqform_id'];?>">
                <div class="content-columns">
                    ...
                    value="<?php echo $findingsData['findings'];?>" readonly>  
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="unit_brand" name="unit_brand" class="repair-input" value="<?php echo $findingsData['unit_brand'];?>" readonly>
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="unit_model" name="unit_model" class="repair-input" value="<?php echo $findingsData['unit_model'];?>" readonly>
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="inspect" name="inspect" class="repair-input" value="<?php echo $findingsData['inspect'];?>" readonly >
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="repairstatus" name="start_date" class="repair-input" value="<?php echo $findingsData['start_date'];?>" readonly >
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="repairstatus" name="assign_tech" class="repair-input" value="<?php echo $findingsData['assign_tech'];?>" readonly>
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="repairstatus" name="assign_tech" class="repair-input" value="<?php echo $findingsData['parts_name'];?>" readonly>
                    </div>

                    <!-- Updated column box for Part Description -->
                    <div class="column-box">
                        <div>Quantity of Parts:</div>
                    </div>

                    <div class="column-box-input">
                    <input type="text" id="repairstatus" name="assign_tech" class="repair-input" value="<?php echo $findingsData['quantity'];?>" readonly>
                    </div>

                    <!-- Cancel and Next buttons -->
                        <div class="button-container">
                        <a href="tfixrepairman_service4.php?user_id=<?php echo $findingsData['user_id'];?>&reqform_id=<?php echo $findingsData['reqform_id'];?>&unit_brand=<?php echo $findingsData['unit_brand'];?>&parts_name=<?php echo $findingsData['parts_name'];?>"><button type="button" class="next-button">UPDATE</button></a>
                            <a href="tfixrepairman_service2.php?user_id=<?php echo $findingsData['user_id'];?>&reqform_id=<?php echo $findingsData['reqform_id'];?>"><button type="button" class="next-button">NEXT</button></a>
                        </div>
                </div>
            </form>`;
        }
