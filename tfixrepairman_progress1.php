    ...
    <script>
       ...
       let problemDescription = "";
        ...
        function showDIAGNOSIS() {
            ...
            <form action="tfixrepairman_endorse.php" method="GET">
                <div class="content-box">
                    ...
                    <div class="checkbox-container">
                        <div class="checkbox-group">
                            ...
                            <label class="checkbox-label">
                                <input type="radio" id="repairstatusYES" name="repairstatus" class="checkbox-input">
                                Yes
                            </label>
                            <label class="checkbox-label">
                                <input type="radio" id="repairstatusNO" name="repairstatus" class="checkbox-input">
                                No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="repair-description">
                        ...
                        <input type="hidden" id="findings" name="findings" class="repair-input" placeholder="Problem description here" style="background-color: #white;">
                    </div>
