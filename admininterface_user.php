...
<head>
    ...
    <style>
        ...
        header {
            ...
            /* Add white border to the bottom of the header */
            display: flex;
            /* Make the header flex container */
        ...
        nav {
            background-color: #1b91ff;
            /* Set navigation background color to blue */
            color: #fff;
            padding: 20px;
            /* Adjusted padding for the navigation */
            display: flex;
            /* Make the navigation flex container */
        ...
        .nav-links {
            margin-left: 20px;
            /* Add some margin to the left of the navigation links */
        }

        .nav-links a {
            padding: 10px;
            /* Adjusted padding for the navigation links */
            text-decoration: none;
            color: #fff;
            /* Set text color to white */
            margin-right: 20px;
            /* Add some margin to the right of each navigation link */
        }
        ...
        .admin-text {
            margin-left: 20px;
            /* Add margin to the left of the "Admin" text */
            font-weight: bold;
            /* Make the text bold */
            font-size: 25px;
        }
...
<body>
    ...
    <section>
        <!-- main content -->
        <div class="new-requests-text">USERS</div>
        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($result as $ownersData) {
                    ...
                    echo "<td>" . $ownersData['email'] . "</td>";
                    echo "<td>" . $ownersData['username'] . "</td>";
                    echo "<td>" . $ownersData['password'] . "</td>";
                    echo "<td>" . $ownersData['role'] . "</td>";
                    // Assuming you want an 'Edit' link for each owner
                    echo "<td style='text-align:center;'>";
                    echo "<form action='admininterface_user1.php' method='POST'>";
                    echo "<input type='hidden' name='user_id' value='" . $ownersData['user_id'] . "'>";
                    echo "<input type='hidden' name='role' value='" . $ownersData['role'] . "'>";
                    echo "<button type='button' name='approve' class='btn btn-primary'>Edit</button>";
                    echo " ";
                    echo "<button type='submit' name='decline' class='btn btn-danger'>Delete</button>";
                    echo "</form>";
                    echo "</td>";
                    echo "</tr>";
                }
