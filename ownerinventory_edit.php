<?php
                            ...
                            $query1 = "SELECT *FROM parts WHERE part_id = '$part_id'";
                            $result1 = mysqli_query($connection, $query1);
                            $partsData = mysqli_fetch_assoc($result1);
...
<header>
    ...
    <thead class="v-2 text-light">
        ...
        <tbody class="v-2 text-light">
            <h1 class="text-light">Edit Part Details</h1>
            
            <form action="ownerinventory_edit1.php" method="POST" class="form-container">
                <input type="hidden" name="part_id" value="<?php echo $partsData['part_id']; ?>">
                <input type="hidden" name="unit_id" value="<?php echo $partsData['unit_id']; ?>">
                <input type="hidden" name="unit_brand" value="<?php echo $partsData['unit_brand']; ?>">

                <div class="form-group mb-3 me-1">
                    <label for="parts_name" class="text-white">Parts Name:</label>
                    <input type="text"  name="parts_name" id="parts_name" value="<?php echo $partsData['parts_name']; ?>">
                </div>

                <div class="form-group mb-3 me-5">
                    <label for="stocks" class="text-white">Number of Stocks:</label>
                    <input type="text"  name="stocks" id="stocks" value="<?php echo $partsData['stocks']; ?>">
                </div>

                <div class="form-group mb-3 ms-3">
                    <label for="price" class="text-white">Price (₱):</label>
                    <input type="text"  name="price" id="price" value="<?php echo $partsData['price']; ?>">
                </div>

                <button type="submit" class="btn btn-primary mt-4">Edit Part</button>
            </form>
            ...
            <div id="addPartsForm" class="popup-form" style="display: none;">
                <h3>Add Parts</h3>
                <form id="partsForm" action="process_parts_add.php" method="post">
                    ...
                    <input type="text" id="parts_name" name="parts_name" required><br><br>
