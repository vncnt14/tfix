...
$query = "SELECT user.user_id, user.firstname, user.lastname, reqform_id, unit_name
          FROM user
...
<body>
    ...
    <nav>
        ...
        <a href="tfixpersonnnel_progress3.php">Progress</a>
        <a href="logout.php">Logout</a>
    </nav>

    <section>
        <!-- MAIN CONTENT -->
        <form class="timeline-section" action="tfixpersonnel_decline-delete.php" method="POST">
            <div class="content-box">
                <div class="checkbox-container">
                    <div class="checkbox-group text-white">
                        <label class="checkbox-label mt-5 ms-3">
                            <input type="hidden" id="reqform_id" name="reqform_id" value="<?php echo $reqformData['reqform_id'];?>">
                            <input type="hidden" id="user_id" name="user_id" value="<?php echo $reqformData['user_id'];?>">
                            <input type="checkbox" id="" name="" class="checkbox-input">
                            Sorry, our technicians are fully booked at the moment
                        </label>
                        <label class="checkbox-label mt-5 ms-3">
                            <input type="checkbox" id="" name="" class="checkbox-input">
                            Sorry, we are undergoing maintenance, and appliance services are temporarily suspended.
                        </label>
                        <label class="checkbox-label mt-5 ms-3">
                            <input type="checkbox" id="" name="" class="checkbox-input">
                            Sorry, our shop is currently not available
                        </label>
                    </div>
                ...
                <div class="button-container">
                    ...
                    <button type="button" class="next-button" onclick="window.history.back();">CANCEL</button>
                </div>
            </div>
        </form>
