        ...
        function showDIAGNOSIS() {
            ...
            <input type="hidden" id="repairman_id" name="repairman_id" value="<?php echo $repaimanData['repairman_id'];?>">
                <div class="content-columns">
                    ...
                    <div class="column-box-input">
                    <input type="text" id="unit_brand" name="unit_brand" class="repair-input" value="<?php echo $reqformData['unit_brand'];?>" readonly>
                    </div>
                    ...
                    <div class="column-box-input">
                    <input type="text" id="repairstatus" name="start_date" class="repair-input" value="<?php echo $reqformData['start_date'];?>">
                    </div>
                    ...
                    <div class="column-box-input">
                        <input type="text" id="quantity" name="parts_name" class="repair-input" min="1" required value="<?php echo $reqformData['parts_name'];?>">
                    </div>
                    ...
                    <div class="column-box-input">
                        <input type="text" id="quantity" name="quantity" class="repair-input" min="1" required value="<?php echo $reqformData['quantity'];?>">
                    </div>
