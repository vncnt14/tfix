	...
	<div class="container">
		...
		<div class="form-group">
			<div class="input-group">
				<input type="hidden" id="registeredAs" name="role" class="form-control" value="user">
        ...
        <div class="input-group">
            <input type="text" id="address" name="address" placeholder="Complete Home Address">
            <i class='bx bx-map'></i>
        </div>
        </div>
        ...
        <p>I already have an account. <a href="tfixlogin.php">Login</a></p>
		</form>
