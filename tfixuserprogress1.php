    ...
    <script>
       ...
       let problemDescription = "";
        ...
        function showDIAGNOSIS() {
            ...
            <form action="tfixuserprogress3.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" id="user_id" name="user_id" value="<?php echo $userData['user_id'];?>">
                <input type="hidden" id="payment" name="payment" value="G CASH">
                ...
                <div class="content-columns">
                    ...
                    <input type="file" id="inspect" name="qrcode" class="repair-input" readonly>
                    </div>
