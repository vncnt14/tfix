...
<head>
    ...
    <style>
        ...
        border-radius: 5px;
        cursor: pointer;
        margin-top: 35px; /* Adjusted margin-top to move it more below */
        ...
        /* CSS for adjusting checkbox size and label alignment */
...
<body>
    ...
    <section>
        ...
        <form action="editowner_picture.php" method="POST" enctype="multipart/form-data">
            
            <div class="shop-details-section">
                <div class="left-section">  
                    <div class="shop-details-profile-box">
                        <img src="<?php echo $ownerData['photo']; ?>" alt="" class="shop-details-profile-image" id="">
                        <input type="hidden" name="owner_id" id="owner_id" value="<?php echo $ownerData['owner_id'];?>">
    ...
    <form class="details-form" action="tfixowner_update.php" method="POST">
    <div class="form-section">
                <label for="shop_name">Shop Name:</label>
                <input type="text" id="shop_name" name="shop_name" value="<?php echo $ownerData['shop_name'];?>" >
            </div>

            <div class="form-section">
                <label for="shop_contact">Shop Contact:</label>
                <input type="text" id="shop_contact" name="shop_contact" value="<?php echo $ownerData['contact'];?>" >
            </div>

            <div class="form-section">
                <label for="shop_location">Shop Location:</label>
                <input type="text" id="shop_location" name="shop_location" value="<?php echo $ownerData['shop_location'];?>" >
            </div>

            <div class="form-section">
                            <label for="email">Email Address:</label>
                            <input type="email" id="email" name="email" value="<?php echo $ownerData['email'];?>" >
                        </div>
...
<input type="checkbox" class="services-checkbox" id="repair" name="service[]" value="repair">
<label for="repair">Repair</label><br>
<input type="checkbox" class="services-checkbox" id="troubleshoot" name="service[]" value="troubleshoot">
<label for="troubleshoot">Troubleshoot</label><br>
<input type="checkbox" class="services-checkbox" id="maintenance" name="service[]" value="maintenance">
<label for="maintenance">Maintenance</label><br>
<input type="checkbox" class="services-checkbox" id="installing" name="service[]" value="installing">
<label for="installing">Installing</label><br>
<input type="checkbox" id="cleaning" name="service[]" value="cleaning">
